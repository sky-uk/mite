...
def scenario1():
    return (("mite_perftest:journey", None, volume_model_factory(1)),)


def scenario10():
    return (("mite_perftest:journey", None, volume_model_factory(10)),)


def scenario100():
    return (("mite_perftest:journey", None, volume_model_factory(100)),)


def scenario1000():
    return (("mite_perftest:journey", None, volume_model_factory(1000)),)
